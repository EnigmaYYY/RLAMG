...
project_name='RLAMG'
exp_name='Qwen2.5-1.5b-Ins-GRPO'
...
MODEL_PATH="/mnt/data/yxy/models/Qwen2.5-1.5B-Instruct"
CKPTS_DIR="/mnt/data/yxy/RL_output/Qwen2.5-1.5B-Ins/checkpoints/${project_name}/${exp_name}"
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python3 -m verl.adaptive_mix_src.main_mix_dapo \
