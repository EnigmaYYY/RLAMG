...
# export http_proxy="http://111.187.82.247:7897"
# export https_proxy="http://111.187.82.247:7897"
...
project_name='Adaptive_Multi_LUFFY_PR'
# exp_name='MIX-DAPO-Qwen2.5-1.5b-adaptive-2longcot_gspo'
exp_name='MIX-DAPO-Qwen3-1.7b-adaptive-2longcot_format_rp'
...
NGPUS_PER_NODE=1
# Paths
HOME=/data/RLAMG/rlamg
RAY_DATA_HOME="${HOME}/verl"
cd $HOME/verl
# very important! please modify the max_position_embeddings in config.json to 32768 after downloading from huggingface
MODEL_PATH="/data1/models/Qwen3-1.7B-Base"
CKPTS_DIR="/data1/RL_output/Qwen3-1.7B/checkpoints/${project_name}/${exp_name}"
TRAIN_FILE="/data/RLAMG/data/openr1_multi_longcot.parquet"
TEST_FILE="/data/RLAMG/data/valid.parquet"
...
actor_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 1 + 100))
# actor_ppo_max_token_len=9316
infer_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 1 + 100))
offload=True
gen_tp=1
fsdp_size=-1
...
CUDA_VISIBLE_DEVICES=2 python3 -m verl.adaptive_mix_src.main_mix_dapo \
