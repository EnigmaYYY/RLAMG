...
project_name='RLAMG'
# exp_name='Qwen2.5-math-7b-GRPO'
exp_name='Llama3.2-8B-Ins-GRPO'
...
# MODEL_PATH="/mnt/data/yxy/models/Qwen2.5-Math-7B-16k-think"
# CKPTS_DIR="/mnt/data/yxy/RL_output/Qwen2.5-Math-7B/checkpoints/${project_name}/${exp_name}"
MODEL_PATH="/mnt/data/yxy/models/Llama-3.2-8B-Instruct"
CKPTS_DIR="/mnt/data/yxy/RL_output/Llama3.2-8B-Ins/checkpoints/${project_name}/${exp_name}"
TRAIN_FILE="/home/yxy/RLAMG/data/openr1-8.5k.parquet"
