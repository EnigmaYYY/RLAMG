...
export WANDB_PROJECT="Adaptive_Multi_LUFFY_PR"

# export EXP_NAME=Multi_LUFFY_TEST_4_clip_always
# export EXP_NAME=Adaptive_Multi_LUFFY_2_LongCoT
# export EXP_NAME="always_multi_2_Qwen2.5-1.5B_longcot_nopr_token_off_loss"
# export EXP_NAME="adaptive_multi_luffy_2_longcot_threshold_2"
# export EXP_NAME="adaptive_multi_2_Qwen2.5-1.5B_longcot_nopr_threshold_2"
# export EXP_NAME="adaptive_multi_2_Qwen2.5-1.5B_longcot_nopr"
export EXP_NAME="adaptive_multi_1_Qwen2.5-1.5B_luffy_threshold_1"
...
CUDA_VISIBLE_DEVICES=1 python3 -m verl.adaptive_mix_src.main_mix_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=$DATA_DIR/openr1-8.5k.parquet \
    data.val_files=$DATA_DIR/valid_math_all.parquet \
    data.train_batch_size=32 \
    data.val_batch_size=32 \
    data.max_prompt_length=1024 \
    data.max_response_length=8192 \
    data.num_off_policy_targets=1 \
