...
# # NCCL configuration to fix distributed training issues
...
export MODEL_PATH=/root/models/Qwen2.5-Math-7B-16k-think
export DATA_DIR=$ROOT/data/
export EXP_NAME=LUFFY-Qwen2.5-Math-7B-8.5k

export WANDB_PROJECT="luffy-math"

cd $ROOT/luffy/verl/

output_dir="/root/RL_output/Qwen2.5-Math-7B/checkpoints/$WANDB_PROJECT/$EXP_NAME"

# Train over a single node, 8 A100-80GB GPUs.
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.mix_src.main_mix_ppo \
