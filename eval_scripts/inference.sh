...
project_name='RLAMG'
exp_name='Qwen2.5-7b-Ins-adaptive-2longcot'
...
MODEL_PATH="/data1/models/${MODEL_NAME}"
TRAIN_FILE="/home/yxy/RLAMG/data/openr1_multi_longcot.parquet"
TEST_FILE="/home/yxy/RLAMG/data/valid_all.parquet"
VALIDATION_OUTPUT_DIR=/data/RLAMG/results
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.adaptive_mix_src.main_mix_dapo \
    ...
    +trainer.validation_data_dir="$VALIDATION_OUTPUT_DIR/$MODEL_NAME"\
